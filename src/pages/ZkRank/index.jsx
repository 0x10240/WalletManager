...
function ZkRank() {
    ...
    const totalExchangeAmountRanges = [
        [[0, 100], 0.349743101],
        [[100, 500], 0.269434993],
        [[500, 1000], 0.095910661],
        [[1000, 10000], 0.195145118],
        [[10000, 50000], 0.066874592],
        [[50000, 250000], 0.018174124],
        [[250000, 1000000], 0.004334639],
        [[1000000, 1000000000], 0.000382771],
      ];
    const balanceRanges =  [
        [[0, 50], 0.902161735],
        [[50, 100], 0.05077929],
        [[100, 500], 0.041094013],
        [[500, 1000], 0.003196206],
        [[1000, 10000], 0.002581452],
        [[10000, 100000], 0.000162388],
