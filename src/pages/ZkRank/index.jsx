...
function ZkRank() {
    ...
    const [ethPrice, setEthPrice] = useState(1625);
    ...
    const totalExchangeAmountRanges = [
        [[0, 100], 0.313641107],
        [[100, 500], 0.23182908],
        [[500, 1000], 0.090425745],
        [[1000, 10000], 0.214187654],
        [[10000, 50000], 0.109703814],
        [[50000, 250000], 0.031367618],
        [[250000, 1000000], 0.007619026],
        [[1000000, 1000000000], 0.001225957],
      ];    
    const balanceRanges =  [
        [[0, 50], 0.93281813],
        [[50, 100], 0.03787759],
        [[100, 500], 0.025324749],
        [[500, 1000], 0.002118232],
        [[1000, 10000], 0.001728386],
        [[10000, 100000], 0.000114616],
    ...
    const columns = [
        ...
        // },
        {
            title: "zkSyncEra 排名 [数据截止 09-10 总地址数 3934886]",
            key: "zks_era_group",
            className: "zks_era",
            children: [
                {
