...
function ZkRank() {
    ...
    const txRanges = [
        ...
        [[20, 49], 0.285616658],
        [[50, 99], 0.191928278],
        [[100, 1000], 0.0990581057],
      ];
    const totalExchangeAmountRanges = [
        [[0, 100], 0.299470057],
        [[100, 500], 0.224679903],
        [[500, 1000], 0.101904799],
        [[1000, 10000], 0.253430689],
        [[10000, 50000], 0.163722642],
        [[50000, 250000], 0.066176738],
        [[250000, 1000000], 0.020721229],
        [[1000000, 1000000000], 0.002609854],
      ];    
    const balanceRanges =  [
        [[0, 5], 0.820303726],
        [[5, 10], 0.058162388],
        ...
        [[50, 100], 0.038216719],
        [[100, 500], 0.031271011],
        [[500, 1000], 0.002191429],
        [[1000, 10000], 0.001982908],
        [[10000, 100000], 0.000127186],
        [[100000, 10000000], 0.0000129],
    ]; 
    const DaysRanges = [
        [[0, 1], 0.2361716],
        [[1, 2], 0.098781592],
