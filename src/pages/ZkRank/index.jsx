...
function ZkRank() {
    ...
    const totalExchangeAmountRanges = [
        [[0, 100], 0.320237519],
        [[100, 500], 0.25901381],
        [[500, 1000], 0.097120523],
        [[1000, 10000], 0.209840225],
        [[10000, 50000], 0.083031946],
        [[50000, 250000], 0.024058404],
        [[250000, 1000000], 0.005945848],
        [[1000000, 1000000000], 0.000751725],
      ];
    const balanceRanges =  [
        [[0, 50], 0.908108647],
        [[50, 100], 0.049207918],
        [[100, 500], 0.037076256],
        [[500, 1000], 0.002930367],
        [[1000, 10000], 0.00248441],
        [[10000, 100000], 0.000163792],
        [[100000, 1000000], 0.0000236],
        [[1000000, 1000000000], 0.000005],
    ];
    const DaysRanges = [
        [[0, 1], 0.274592604],
        [[1, 2], 0.155913823], 
    ...
    const columns = [
        ...
        // },
        {
            title: "zkSyncEra 排名 [数据截止 07-12 总地址数 2796237]",
            key: "zks_era_group",
            className: "zks_era",
            children: [
                {
